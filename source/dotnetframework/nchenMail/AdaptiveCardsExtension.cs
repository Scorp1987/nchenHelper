...
namespace AdaptiveCards.Types
{
    public static class AdaptiveCardsExtension
    {
        private static string ToHtmlColor(this Color color)
        {
            switch (color)
            {
                case Color.Good: return "Green";
                case Color.Attention: return "Red";
                case Color.Warning: return "Orange";
                case Color.Light: return "Grey";
                case Color.Dark: return "Black";
                case Color.Accent: return "Blue";
                default: return null;
            }
        }
        private static string ToHtmlFontSize(this FontSize size)
        {
            switch (size)
            {
                case FontSize.Small: return "10pt";
                case FontSize.Medium: return "15pt";
                case FontSize.Large: return "18pt";
                case FontSize.ExtraLarge: return "22pt";
                default: return "12pt";
            }
        }
        private static string ToHtmlFontWeight(this FontWeight weight)
        {
            switch (weight)
            {
